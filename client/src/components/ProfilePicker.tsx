    ...
    <div ref={rootRef} className="relative w-full min-w-0">
      ...
      {open && (
        <div
          ...
          className="absolute bottom-[calc(100%+0.5rem)] left-0 z-50 w-full overflow-hidden rounded-xl border border-zinc-200 bg-white p-1.5 shadow-xl shadow-zinc-950/10 dark:border-zinc-700 dark:bg-zinc-900 dark:shadow-black/30"
        >
            ...
            {profiles.map((profile) => {
              ...
              return (
                <button
                  ...
                  className={`flex w-full min-w-0 items-start gap-2.5 rounded-lg px-2 py-2 text-left transition-colors ${
                    selected
